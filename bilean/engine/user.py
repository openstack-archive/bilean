...
class User(object):
    ...
    def update_rate(self, context, delta_rate, delayed_cost=0):
        ...
        self._settle_account(context, delayed_cost=delayed_cost)
    ...
    def _settle_account(self, context, delayed_cost=0):
